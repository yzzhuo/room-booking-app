  ...
  <main class="p-6">
    ...
    <section class="mb-8">
      ...
      <div class="border-solid border-2 border-gray-100 rounded flex gap-4">
        <ResourceCard class="flex-1" title="Booking a Room" />
        <ResourceCard class="flex-1" title="View My Bookings" />
      </div>
    </section>
    <!-- Upcoming Bookings -->
    <section class="mb-8">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          >
            ...
            <button 
              ...
              class="w-full border-2 border-gray-300 rounded py-1 hover:bg-gray-50"
            >
              Book
            </button>
          </div>
